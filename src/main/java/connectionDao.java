...
public class connectionDao implements animalsDao{
    ...
    public static void addAnimals(Animals newAnimalReport) {
        ...
        Sql2o sql2o = new Sql2o("jdbc:postgresql://ec2-54-165-184-219.compute-1.amazonaws.com:5432/d1boqhjufs16fj", "bcnrhybrxfpqpm", "09b95c311debd08b98cf33230a07bdbcef06359e154fb83a896af02173fc9797");// sql2o object that manages the(LOCAL) conncetion to database
